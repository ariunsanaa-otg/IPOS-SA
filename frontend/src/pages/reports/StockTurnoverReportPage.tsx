...
export function StockTurnoverReportPage() {
    ...
    const cols: TableColumn<Row>[] = [
        ...
        { key: 'netChange',         header: 'Net',      align: 'right', render: r => (
                <strong className="mono" style={{ color: r.netChange >= 0 ? 'var(--color-success)' : 'var(--color-danger)' }}>
    ...
    return (
        <Page title="Stock Turnover Report" subtitle="Stock received vs goods sold within a given period"
